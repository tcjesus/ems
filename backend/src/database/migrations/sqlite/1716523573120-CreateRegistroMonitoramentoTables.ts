...
export class CreateRegistroMonitoramentoTables1716523573120 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('CREATE INDEX "IDX_f8bb154cc02ae59be47274afdd" ON "monitoramento_raw_data" ("deleted_at") ');
        ...
        await queryRunner.query(
            ...
            '  CONSTRAINT "FK_5f863808d7b1f065b8596773a90" FOREIGN KEY ("raw_data_id") REFERENCES "monitoramento_raw_data" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, ' +
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('DROP INDEX "IDX_fb0dde7b7412071c72854328b0"');
        await queryRunner.query('DROP TABLE "registro_monitoramento"');
        await queryRunner.query('DROP INDEX "IDX_a8e3451f8a3f494203b5013b61"');
